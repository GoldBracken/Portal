...
// function for showing a message when incorrect format is added to the forms
function formSubmit() {
...
// function to create a table with links to ice projects
...
// Populates project list with JSON
function creatList() {
